...
class CryptoPaperBot:
    ...
    async def run_micro_once(self):
        ...
        surge_ranking_1h = sorted(candidates, key=lambda row: row["pct1h"], reverse=True)
        await self._archive_micro_surge_if_due(surge_ranking_1h, archive_sources)
