...
_DEFAULT_MICRO_ACTIVE = (
    ...
    "auto_top2_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl1.2_be0.6_tr0.9x0.4_t12",
    "auto_top3_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl1.2_be0.6_tr0.9x0.4_t18",
...
MICRO_TOP10_OPTIMIZED_STRATEGIES = {
    # === 2026-06-16 00:00 optimizer winners (4H cycle, 14d lookback, vol_ratio>=1.0, min_trades>=10) ===
    # Entry: delay=3, max_rank=3, chg=3-10%, green_confirm, max_upper_wick=1.2%, min_vol=1.0x, reclaim=false, dur=10-40
    # All 3 meet criteria: net_avg>0, PF>1.5, max_loss>-2%, WR>40%, trades>=10 (79 closed trades)
    # Top 1 (sl1.2): net_avg=0.662%, WR=58.2%, PF=2.63, max_loss=-1.36%, trades=79
    # Top 2 (sl1.0): net_avg=0.655%, WR=55.7%, PF=2.66, max_loss=-1.16%, trades=79
    # Top 3 (sl0.8): net_avg=0.650%, WR=53.2%, PF=2.69, max_loss=-0.96%, trades=79
    "auto_top1_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl1.2_be0.6_tr0.9x0.4_t8": {
    ...
    "auto_top2_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl1.0_be0.6_tr0.9x0.4_t8": {
    ...
    "auto_top3_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl0.8_be0.6_tr0.9x0.4_t8": {
...
# === Strategy 4.1 (production backtest positive) ===
    ...
    # === 2026-06-14 4H optimizer winners (14d lookback, vol_ratio>=1.0) ===
    # Entry: delay=3, max_rank=3, chg=3-10%, green_confirm, max_upper_wick=0.8%, min_vol_ratio=2.0, reclaim_entry_price=true, session_dur=10-40
    # All 3 meet criteria: net_avg>0, PF>1.5, max_loss>-2%, WR>40%, trades>=10
    # Top 1: net_avg=1.77%, WR=63.6%, PF=6.34, max_loss=-1.16%, trades=11
    ...
    # === 2026-06-15 04:00 optimizer winners (4H cycle, 14d lookback, vol_ratio=1.0) ===
    # Entry: delay=3, max_rank=3, chg=3-10%, green_confirm, max_upper_wick=1.2%, min_vol_ratio=1.0, reclaim_entry_price=false, dur=10-40
    # All 3 meet criteria: net_avg>0, PF>2.6, max_loss>-1.4%, WR>57%, trades=77
    # Top 1: net_avg=0.693%, WR=57.14%, PF=2.84, max_loss=-1.16%
    # Top 2: net_avg=0.693%, WR=57.14%, PF=2.84, max_loss=-1.16%
    # Top 3: net_avg=0.693%, WR=57.14%, PF=2.84, max_loss=-1.16%
    "auto_top1_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl1.0_be0.6_tr0.9x0.4_t8": {
        "version": "auto_top1_4h",
        "entry_delay_bars": 3,
        "max_rank": 3,
    ...
    # === 2026-06-16 04:00 optimizer winners (4H cycle, 14d lookback, vol_ratio>=1.0) ===
    # Entry: delay=3, max_rank=3, chg=3-10%, green_confirm, max_upper_wick=1.2%, min_vol_ratio=1.0, reclaim=False, dur=10-40
    # All 3 meet criteria: net_avg>0, PF>1.5, max_loss>-2%, WR>40%, trades>=10
    # Top 1: net_avg=0.686%, WR=57.69%, PF=2.67, max_loss=-1.36%, trades=78
    "auto_top1_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl1.2_be0.6_tr0.9x0.4_t8": {
        "version": "auto_top1_4h",
        "entry_delay_bars": 3,
        "max_rank": 3,
    ...
    # Top 2: net_avg=0.686%, WR=57.69%, PF=2.67, max_loss=-1.36%, trades=78
    "auto_top2_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl1.2_be0.6_tr0.9x0.4_t12": {
        "version": "auto_top2_4h",
        "entry_delay_bars": 3,
        "max_rank": 3,
    ...
    # Top 3: net_avg=0.686%, WR=57.69%, PF=2.67, max_loss=-1.36%, trades=78
    "auto_top3_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur1040_sl1.2_be0.6_tr0.9x0.4_t18": {
        "version": "auto_top3_4h",
        "entry_delay_bars": 3,
        "max_rank": 3,
