...
_DEFAULT_MICRO_ACTIVE = (
    "auto_top1_4h_d3_r3_chg2-8_green_uw12_vol15_sl0.8_be0.6_tr0.9x0.4_t8_20260612_1230,"
    "auto_top2_4h_d3_r3_chg2-8_green_uw12_vol15_sl1.0_be0.6_tr0.9x0.4_t8_20260612_1230,"
    "auto_top3_4h_d3_r3_chg1-12_green_uw12_vol15_sl0.8_be0.6_tr0.9x0.4_t8_20260612_1230,"
...
MICRO_TOP10_OPTIMIZED_STRATEGIES = {
    ...
    # 2026-06-07 11:00 Taiwan scan winners. These are deployed to Render as
    # paper/shadow candidates only. They must accumulate live paper evidence
    # before any OKX real-money promotion, even though the local point-in-time
    # replay is positive after fee/slippage.
    "top10scan_d2_r5_chg2-8_cur2_vol1.2_sl0.8_tr1.5x0.5_t12": {
        "version": "top10scan_d2_r5_chg2_8_cur2_vol12_sl08_tr15x05_t12",
        "entry_delay_bars": 2,
        "max_rank": 5,
        "min_change_1h_pct": 2.0,
    ...
    "top10scan_d1_r3_chg3-12_cur1_vol0_sl1_tr1.5x0.5_t12": {
        "version": "top10scan_d1_r3_chg3_12_cur1_vol0_sl1_tr15x05_t12",
        "entry_delay_bars": 1,
        "max_rank": 3,
        "min_change_1h_pct": 3.0,
        "max_change_1h_pct": 12.0,
    ...
    "top10scan_d1_r3_chg3-12_cur2_vol0_sl1_tr1.5x0.5_t12": {
        "version": "top10scan_d1_r3_chg3_12_cur2_vol0_sl1_tr15x05_t12",
        "entry_delay_bars": 1,
        "max_rank": 3,
        "min_change_1h_pct": 3.0,
        "max_change_1h_pct": 12.0,
    ...
    "top10scan_d2_r5_chg2-8_cur2_vol1.2_sl1_tr1.5x0.5_t12": {
        "version": "top10scan_d2_r5_chg2_8_cur2_vol12_sl1_tr15x05_t12",
        "entry_delay_bars": 2,
        "max_rank": 5,
        "min_change_1h_pct": 2.0,
        "max_change_1h_pct": 8.0,
    ...
    "top10scan_d1_r3_chg3-12_cur1_vol0_sl1_tr1x0.5_t12": {
        "version": "top10scan_d1_r3_chg3_12_cur1_vol0_sl1_tr1x05_t12",
        "entry_delay_bars": 1,
        "max_rank": 3,
        "min_change_1h_pct": 3.0,
        "max_change_1h_pct": 12.0,
    ...
    # Render shadow-only probes: intentionally looser than the strict top10scan
    # set so Render can accumulate paper/shadow samples. These are NOT OKX
    # live-ready IDs; promotion logic/reporting must treat shadow_only=True as
    # research-only until enough Render evidence proves otherwise.
    ...
    "top10shadow2_d0_r10_chg1_20_cur0_sl12_tr15x06_t12": {
        "version": "top10shadow2",
        "entry_delay_bars": 0,
        "max_rank": 10,
        "min_change_1h_pct": 1.0,
        "max_change_1h_pct": 20.0,
        "min_current_change_1h_pct": 0.0,
        "require_change_reclaim": False,
        "min_volume_ratio": 0.0,
        "shadow_only": True,
    ...
    # === New live-candidate strategies from 11:00 optimizer (2026-06-09) ===
    ...
    # === Auto-optimized strategies from 4H scheduler (2026-06-12 04:00) ===
    # Entry: delay=3, max_rank=3, chg=2-8%, green_confirm, max_upper_wick=1.2%, min_vol_ratio=1.5
    # Exit: sl=0.8, be=0.6, trail=0.9x0.4, time_stop varies
    # All 3 passed: net_avg_return>0, profit_factor>1.5, max_loss>-2%, win_rate>40%, trades>=30
    # WR=56.67%, PF=4.34, net_avg=1.12%, max_loss=-0.96%
    ...
    # Entry: delay=2, max_rank=3, chg=3-10%, green_confirm, max_upper_wick=0.8%, reclaim_entry_price
    # Exit: pure SL + Trail + Time stop (NO breakeven) - matching optimizer exactly
    ...
    # === Sweep strategies from param sweep (2026-06-10) ===
    # Best: d2_r3_chg2-8_green_sl2_tr0.8x0.4_t18 (WR=69.5%, PF=1.07)
    ...
    # Same params but NO session tracking dedup (for testing true PF/WR)
    ...
    # === 優化器最佳參數完整複製 ===
    # d2_r3_chg3-10_green_reclaim + sl1.5_be0.6_tr0.9x0.4_t8
    # 原優化器：WR=57.1%, PF=3.95, max_loss=-1.66%
    ...
    # Refined: add uw≤1.2%, reclaim, SL 1.2%, trail 1.2x0.5, t12, be0.8
    ...
    # === Auto-optimized strategies from 4H scheduler (2026-06-12 12:30) ===
    # Entry: delay=3, max_rank=3, chg=2-8%, green_confirm, max_upper_wick=1.2%, min_vol_ratio=1.5
    # Exit: SL=0.8%, BE=0.6%, trail=0.9x0.4%, time_stop=8
    # Passed: net_avg_return=1.12%>0, profit_factor=4.34>1.5, max_loss=-0.96%>-2%, win_rate=56.67%>40%, trades=30>=30
    "auto_top1_4h_d3_r3_chg2-8_green_uw12_vol15_sl0.8_be0.6_tr0.9x0.4_t8_20260612_1230": {
        "version": "auto_top1_4h",
        "entry_delay_bars": 3,
        "max_rank": 3,
    ...
    # Entry: delay=3, max_rank=3, chg=2-8%, green_confirm, max_upper_wick=1.2%, min_vol_ratio=1.5
    # Exit: SL=1.0%, BE=0.6%, trail=0.9x0.4%, time_stop=8
    # Passed: net_avg_return=1.12%>0, profit_factor=4.08>1.5, max_loss=-1.16%>-2%, win_rate=60.00%>40%, trades=30>=30
    "auto_top2_4h_d3_r3_chg2-8_green_uw12_vol15_sl1.0_be0.6_tr0.9x0.4_t8_20260612_1230": {
        "version": "auto_top2_4h",
        "entry_delay_bars": 3,
        "max_rank": 3,
    ...
    # Entry: delay=3, max_rank=3, chg=1-12%, green_confirm, max_upper_wick=1.2%, min_vol_ratio=1.5
    # Exit: SL=0.8%, BE=0.6%, trail=0.9x0.4%, time_stop=8
    # Passed: net_avg_return=1.09%>0, profit_factor=4.30>1.5, max_loss=-0.96%>-2%, win_rate=54.05%>40%, trades=37>=30
    "auto_top3_4h_d3_r3_chg1-12_green_uw12_vol15_sl0.8_be0.6_tr0.9x0.4_t8_20260612_1230": {
        "version": "auto_top3_4h",
        "entry_delay_bars": 3,
        "max_rank": 3,
