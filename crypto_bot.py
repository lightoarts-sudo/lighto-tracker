...
MICRO_TOP10_OPTIMIZED_STRATEGIES = {
    # === 2026-06-15 20:00 optimizer winners (4H cycle, 14d lookback) ===
    # Entry: delay=3, max_rank=3, chg=3-10%, green_confirm, max_upper_wick=1.2%, min_vol=1.0x, reclaim=false, dur=10-40
    # All 3 meet criteria: net_avg>0, PF>1.5, max_loss>-2%, WR>40%, trades>=10 (77 closed trades)
    # Top 1 (sl1.0): net_avg=0.674%, WR=55.8%, PF=2.73, max_loss=-1.16%, trades=77
    ...
    "auto_top1_4h_d3_r3_chg3-10_greenuw1.2_vol10_dur55_atr2-15_sl1.0_be0.6_tr0.9x0.4_t8": {
