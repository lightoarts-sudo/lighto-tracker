...
MICRO_TOP10_OPTIMIZED_STRATEGIES = {
    ...
    # Backtest: WR=56.67%, PF=4.34, net_avg=1.12%, max_loss=-0.96%, trades=30
    "auto_top1_4h_d3_r3_chg2-8_green_uw12_vol15_sl0.8_be0.6_tr0.9x0.4_t8": {
    ...
    # === Sweep best strategy ===
    # Entry: delay=2, max_rank=3, chg=2-8%, green_confirm
    # Exit: SL=2.0%, trail=0.8x0.4, time_stop=18
    "sweep_best_d2_r3_chg2-8_green_sl2_tr0.8x0.4_t18": {
        "version": "sweep_best",
        "entry_delay_bars": 2,
        "max_rank": 3,
    ...
    # === Top5 quality score strategy ===
    # Entry: quality score >= 95, chg=2-5%
    "top5dplus_score95_chg2_5_sl1_tr06x03_t6": {
        "version": "top5dplus",
        "entry_delay_bars": 0,
        "max_rank": 5,
