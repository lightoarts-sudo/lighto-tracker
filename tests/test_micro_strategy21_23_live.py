...
def test_strategy20_23_and_22_helpers_are_now_active_top10_strategies():
    ...
    # New auto-optimized strategies (now in default active set)
    assert crypto_bot.micro_strategy_enabled("auto_top1_4h_d2_r3_chg3-10_green_uw08_reclaim_sl1.5_be0.6_tr0.9x0.4_t8")
    assert crypto_bot.micro_strategy_enabled("auto_top2_4h_d2_r3_chg3-10_green_uw08_reclaim_sl1.5_be0.6_tr0.9x0.4_t12")
    assert crypto_bot.micro_strategy_enabled("auto_top3_4h_d2_r3_chg3-10_green_uw08_reclaim_sl1.5_be0.6_tr0.9x0.4_t18")
    
    # strategy20 and strategy4 now in default active set
