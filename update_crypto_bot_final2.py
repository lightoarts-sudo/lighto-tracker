...
# Add comment header (same as original)
comment_header = [
...
# Replace lines 647-703 (1-indexed) = indices 646-702 (0-indexed inclusive)
# So slice is lines[646:703]
print(f"Line 646 (idx 645): {lines[645].strip()}")
print(f"Line 647 (idx 646): {lines[646].strip()}")
print(f"Line 703 (idx 702): {lines[702].strip()}")
print(f"Line 704 (idx 703): {lines[703].strip()}")

new_auto_block = comment_header + new_auto_lines
lines[646:703] = new_auto_block
