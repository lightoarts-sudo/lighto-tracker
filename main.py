"""
Lighto ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ¦ÃÂ¨ÃÂ£ - EDM ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ½ÃÂ¨ÃÂ¹ÃÂ¤ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂ
ÃÂ¤ÃÂ½ÃÂ¿ÃÂ§ÃÂÃÂ¨ asyncpg (PostgreSQL) / aiosqlite (SQLite fallback)
"""
...
# ÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ£ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂ UTC+8
TW_TZ = timezone(timedelta(hours=8))

def tw_str(ts) -> str:
    """ÃÂ¦ÃÂÃÂ datetime ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ­ÃÂÃÂ¤ÃÂ¸ÃÂ²ÃÂ¨ÃÂ½ÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ£ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ©ÃÂ¡ÃÂ¯ÃÂ§ÃÂ¤ÃÂº"""
    if ts is None:
        return ""
...
# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ DB ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ½ÃÂ ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
<title>ÃÂ¥ÃÂ·ÃÂ²ÃÂ¥ÃÂÃÂÃÂ¦ÃÂ¶ÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ± - Lighto ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ¦ÃÂ¨ÃÂ£</title></head>
...
<div style="background:#fff;border-radius:12px;padding:48px 40px;max-width:480px;text-align:center;">
  <p style="font-size:32px;margin:0 0 16px;">ÃÂ°ÃÂÃÂÃÂ²</p>
  <h1 style="font-size:22px;font-weight:700;color:#1a1a1a;margin:0 0 12px;">ÃÂ¥ÃÂ·ÃÂ²ÃÂ¥ÃÂÃÂÃÂ¦ÃÂ¶ÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ±</h1>
  <p style="font-size:15px;color:#666;line-height:1.7;margin:0 0 24px;">
    <b>{email}</b><br>ÃÂ¥ÃÂ·ÃÂ²ÃÂ¥ÃÂ¾ÃÂ Lighto ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ¦ÃÂ¨ÃÂ£ ÃÂ©ÃÂÃÂ»ÃÂ¥ÃÂ­ÃÂÃÂ¥ÃÂ ÃÂ±ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂ­ÃÂ§ÃÂ§ÃÂ»ÃÂ©ÃÂÃÂ¤ÃÂ£ÃÂÃÂ<br>
    ÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¯ÃÂÃÂ©ÃÂÃÂÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂÃÂ©ÃÂÃÂÃÂ§ÃÂÃÂ¥ÃÂ§ÃÂµÃÂ¦ÃÂ¦ÃÂÃÂ¨ÃÂ£ÃÂÃÂ<br>
    <span style="font-size:13px;color:#aaa;">{tw_now} (ÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ£ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ)</span>
  </p>
  <a href="https://www.lightochan.com"
     style="display:inline-block;padding:12px 28px;background:#1a1a1a;color:#fff;
            text-decoration:none;border-radius:6px;font-size:14px;">
    ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ° Lighto ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ¦ÃÂ¨ÃÂ£
  </a>
</div>
</td></tr></table>
</body></html>""")

# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ API ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def dashboard(pwd: str = Query(""), search: str = Query("")):
    if pwd != DASHBOARD_PASSWORD:
        ...
        <h2>ÃÂ°ÃÂÃÂÃÂ Lighto EDM ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¨ÃÂ¹ÃÂ¤ÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ¦ÃÂÃÂ¿</h2>
        <form method="get"><input name="pwd" type="password" placeholder="ÃÂ¥ÃÂ¯ÃÂÃÂ§ÃÂ¢ÃÂ¼"
        style="padding:8px;width:200px;">
        <button type="submit" style="padding:8px 16px;margin-left:8px;">ÃÂ§ÃÂÃÂ»ÃÂ¥ÃÂÃÂ¥</button>
    ...
    unsub_rows = "".join(
        ...
        f"padding:3px 10px;cursor:pointer;font-size:12px;'>ÃÂ¥ÃÂÃÂªÃÂ©ÃÂÃÂ¤</button></td></tr>"
        for r in unsub_list
    )
    ...
    if search:
        search_section = f"""
<div class="card">
  <h2>ÃÂ°ÃÂÃÂÃÂ ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ°ÃÂÃÂ§ÃÂµÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ{search}ÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂ± {search_count} ÃÂ§ÃÂ­ÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ</h2>
  {'<p style="color:#aaa;font-size:14px;">ÃÂ§ÃÂÃÂ¡ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ§ÃÂ´ÃÂÃÂ©ÃÂÃÂ</p>' if not search_count else f'''
  <table><tr><th>ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ (ÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ£)</th><th>Product ID</th><th>ÃÂ§ÃÂÃÂ¢ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ§ÃÂ¨ÃÂ±</th><th>ÃÂ¥ÃÂÃÂ§ÃÂ¥ÃÂ®ÃÂ¹</th><th>ÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂ</th></tr>
  {search_rows}</table>'''}
</div>"""

    return HTMLResponse(html_head("Lighto EDM ÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ¦ÃÂÃÂ¿") + f"""
<div class="card">
  <h1>Lighto ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ°ÃÂ¦ÃÂ¨ÃÂ£ EDM ÃÂ¨ÃÂ¿ÃÂ½ÃÂ¨ÃÂ¹ÃÂ¤ÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ¦ÃÂÃÂ¿</h1>
  <p style="color:#888;margin:0 0 20px;font-size:13px;">
    <a href="/api/clicks?pwd={pwd}">JSON API</a> ÃÂÃÂ·
    <a href="/dashboard?pwd={pwd}">ÃÂ©ÃÂÃÂÃÂ¦ÃÂÃÂ°ÃÂ¦ÃÂÃÂ´ÃÂ§ÃÂÃÂ</a> ÃÂÃÂ·
    ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ§ÃÂÃÂºÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ£ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ (UTC+8)
  </p>
  <div>
    <div class="stat"><div class="n">{total}</div><div class="l">ÃÂ§ÃÂ¸ÃÂ½ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¸</div></div>
    <div class="stat"><div class="n">{uniq}</div><div class="l">ÃÂ¤ÃÂ¸ÃÂÃÂ©ÃÂÃÂÃÂ¨ÃÂ¤ÃÂÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶</div></div>
    <div class="stat unsub"><div class="n">{unsubs}</div><div class="l">ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ¤ÃÂºÃÂºÃÂ¦ÃÂÃÂ¸</div></div>
  </div>
</div>
<div class="card">
  <h2>ÃÂ°ÃÂÃÂÃÂ ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ°ÃÂÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ</h2>
  <form method="get" action="/dashboard">
    <input type="hidden" name="pwd" value="{pwd}">
    <div class="search-bar">
      <input type="text" name="search" placeholder="ÃÂ¨ÃÂ¼ÃÂ¸ÃÂ¥ÃÂÃÂ¥ÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ Email..." value="{search}">
      <button type="submit">ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ°ÃÂ</button>
    </div>
  </form>
</div>
{search_section}
<div class="card"><h2>ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ»ÃÂ£ÃÂ¥ÃÂÃÂÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂ <span style="font-size:13px;color:#888;font-weight:normal;">ÃÂ¯ÃÂ¼ÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ§ÃÂ¨ÃÂ±ÃÂ¦ÃÂÃÂ¥ÃÂ§ÃÂÃÂÃÂ¨ÃÂ©ÃÂ³ÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ</span></h2>
<table><tr><th>ÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂÃÂ¦ÃÂ¨ÃÂÃÂ©ÃÂ¡ÃÂ</th><th>ÃÂ¤ÃÂ¿ÃÂ¡ÃÂ¤ÃÂ»ÃÂ¶ÃÂ¦ÃÂ¨ÃÂÃÂ©ÃÂ¡ÃÂ</th><th>ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¸</th></tr>{camp_rows}</table></div>
<div class="card"><h2>ÃÂ¥ÃÂÃÂÃÂ§ÃÂÃÂ¢ÃÂ¥ÃÂÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂ</h2>
<table><tr><th>Product ID</th><th>ÃÂ§ÃÂÃÂ¢ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ§ÃÂ¨ÃÂ±</th><th>ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¸</th></tr>{prod_rows}</table></div>
<div class="card">
  <h2 style="color:#c0392b;">ÃÂ°ÃÂÃÂÃÂ« ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ®ÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂ± {unsubs} ÃÂ¤ÃÂºÃÂºÃÂ¯ÃÂ¼ÃÂ</h2>
  {'<p style="color:#aaa;font-size:14px;">ÃÂ§ÃÂÃÂ®ÃÂ¥ÃÂÃÂÃÂ§ÃÂÃÂ¡ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ</p>' if not unsub_list else f'''
  <table><tr><th>ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ (ÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ£)</th><th>Email</th><th>ÃÂ¤ÃÂ¾ÃÂÃÂ¦ÃÂºÃÂÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂ</th><th style="width:60px">ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ½ÃÂ</th></tr>
  {unsub_rows}</table>'''}
</div>
<script>
async function delUnsub(email, btn) {{
  if (!confirm('ÃÂ§ÃÂ¢ÃÂºÃÂ¥ÃÂ®ÃÂÃÂ¨ÃÂ¦ÃÂÃÂ¥ÃÂ¾ÃÂÃÂ©ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂ®ÃÂ¤ÃÂ¸ÃÂ­ÃÂ§ÃÂ§ÃÂ»ÃÂ©ÃÂÃÂ¤ ' + email + ' ÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ\\nÃÂ§ÃÂ§ÃÂ»ÃÂ©ÃÂÃÂ¤ÃÂ¥ÃÂ¾ÃÂÃÂ¦ÃÂ­ÃÂ¤ÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂ¬ÃÂ¡ÃÂ¦ÃÂÃÂ¶ÃÂ¥ÃÂÃÂ° EDM ÃÂ¦ÃÂÃÂÃÂ¤ÃÂ¸ÃÂÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¢ÃÂ«ÃÂ©ÃÂÃÂÃÂ¦ÃÂ¿ÃÂ¾ÃÂ£ÃÂÃÂ')) return;
  ...
  try {{
    ...
    else {{ alert('ÃÂ¥ÃÂÃÂªÃÂ©ÃÂÃÂ¤ÃÂ¥ÃÂ¤ÃÂ±ÃÂ¦ÃÂÃÂ'); btn.disabled = false; btn.textContent = 'ÃÂ¥ÃÂÃÂªÃÂ©ÃÂÃÂ¤'; }}
  }} catch(e) {{ alert('ÃÂ§ÃÂ¶ÃÂ²ÃÂ¨ÃÂ·ÃÂ¯ÃÂ©ÃÂÃÂ¯ÃÂ¨ÃÂªÃÂ¤'); btn.disabled = false; btn.textContent = 'ÃÂ¥ÃÂÃÂªÃÂ©ÃÂÃÂ¤'; }}
}}
</script>
<div class="card"><h2>ÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¿ÃÂ 100 ÃÂ§ÃÂ­ÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂ <span style="font-size:13px;color:#888;font-weight:normal;">ÃÂ¯ÃÂ¼ÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂ Email ÃÂ¦ÃÂÃÂ¥ÃÂ§ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ</span></h2>
<table>
  <tr><th>ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ (ÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ£)</th><th>ÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ Email</th><th>Product ID</th><th>ÃÂ§ÃÂÃÂ¢ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ§ÃÂ¨ÃÂ±</th><th>ÃÂ¥ÃÂÃÂ§ÃÂ¥ÃÂ®ÃÂ¹</th><th>ÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂ</th></tr>
  {rec_rows}
</table></div>
</body></html>""")
...
async def customer_detail(pwd: str = Query(""), email: str = Query("")):
    ...
    unsub_badge = '<span style="background:#c0392b;color:#fff;padding:2px 10px;border-radius:4px;font-size:13px;margin-left:8px;">ÃÂ¥ÃÂ·ÃÂ²ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¨ÃÂ</span>' if is_unsub else ""
    click_rows = "".join(
        f"<tr><td style='color:#888;font-size:12px'>{tw_str(r['ts'])}</td>"
    ...
    return HTMLResponse(html_head(f"ÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ - {email}") + f"""
<a class="back-link" href="/dashboard?pwd={pwd}">ÃÂ¢ÃÂÃÂ ÃÂ¨ÃÂ¿ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ¦ÃÂÃÂ¿</a>
<div class="card">
  <h1>{email} {unsub_badge}</h1>
  <p style="color:#888;font-size:13px;margin:8px 0 0;">ÃÂ¥ÃÂÃÂ± {len(rows)} ÃÂ§ÃÂ­ÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ</p>
</div>
{'<div class="card" style="border:2px solid #c0392b;"><p style="color:#c0392b;margin:0;font-weight:600;">ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ ÃÂ¦ÃÂ­ÃÂ¤ÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ÃÂ¥ÃÂ·ÃÂ²ÃÂ©ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¨ÃÂ«ÃÂÃÂ¥ÃÂÃÂ¿ÃÂ¥ÃÂÃÂÃÂ¥ÃÂ¯ÃÂÃÂ©ÃÂÃÂ EDM</p></div>' if is_unsub else ''}
<div class="card">
  <h2>ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂ°ÃÂ§ÃÂÃÂ£ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ</h2>
  {'<p style="color:#aaa;">ÃÂ§ÃÂÃÂ¡ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¨ÃÂ¨ÃÂÃÂ©ÃÂÃÂ</p>' if not rows else f'''
  <table><tr><th>ÃÂ¦ÃÂÃÂÃÂ©ÃÂÃÂ</th><th>Product ID</th><th>ÃÂ§ÃÂÃÂ¢ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ§ÃÂ¨ÃÂ±</th><th>ÃÂ¥ÃÂÃÂ§ÃÂ¥ÃÂ®ÃÂ¹</th><th>ÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂ</th><th>ÃÂ©ÃÂÃÂ£ÃÂ§ÃÂµÃÂ</th></tr>
  {click_rows}</table>'''}
</div>
</body></html>""")

# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Campaign ÃÂ¨ÃÂ©ÃÂ³ÃÂ¦ÃÂÃÂÃÂ©ÃÂ ÃÂ ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
...
async def campaign_detail(pwd: str = Query(""), name: str = Query("")):
    ...
    return HTMLResponse(html_head(f"ÃÂ¦ÃÂ´ÃÂ»ÃÂ¥ÃÂÃÂÃÂ¨ÃÂ©ÃÂ³ÃÂ¦ÃÂÃÂ - {name}") + f"""
<a class="back-link" href="/dashboard?pwd={pwd}">ÃÂ¢ÃÂÃÂ ÃÂ¨ÃÂ¿ÃÂÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ¦ÃÂÃÂ¿</a>
<div class="card">
  <h1>ÃÂ°ÃÂÃÂÃÂ¢ {name}</h1>
  <div style="margin-top:16px;">
    <div class="stat"><div class="n">{total_clicks}</div><div class="l">ÃÂ§ÃÂ¸ÃÂ½ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¸</div></div>
    <div class="stat"><div class="n">{uniq_customers}</div><div class="l">ÃÂ¦ÃÂÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ÃÂ¦ÃÂÃÂ¸</div></div>
  </div>
</div>
<div class="card"><h2>ÃÂ¥ÃÂÃÂÃÂ§ÃÂÃÂ¢ÃÂ¥ÃÂÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂ</h2>
<table><tr><th>Product ID</th><th>ÃÂ§ÃÂÃÂ¢ÃÂ¥ÃÂÃÂÃÂ¥ÃÂÃÂÃÂ§ÃÂ¨ÃÂ±</th><th>ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂ¸</th></tr>{prod_rows}</table></div>
<div class="card"><h2>ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ÃÂ¥ÃÂÃÂÃÂ¨ÃÂ¡ÃÂ¨ÃÂ¯ÃÂ¼ÃÂÃÂ¥ÃÂÃÂ 200 ÃÂ¥ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ<span style="font-size:13px;color:#888;font-weight:normal;">ÃÂ¯ÃÂ¼ÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂ Email ÃÂ¦ÃÂÃÂ¥ÃÂ§ÃÂÃÂÃÂ¨ÃÂ©ÃÂ³ÃÂ¦ÃÂÃÂÃÂ¯ÃÂ¼ÃÂ</span></h2>
<table><tr><th>ÃÂ¥ÃÂ®ÃÂ¢ÃÂ¦ÃÂÃÂ¶ Email</th><th>ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂÃÂ¦ÃÂ¬ÃÂ¡ÃÂ¦ÃÂÃÂ¸</th><th>ÃÂ©ÃÂ¦ÃÂÃÂ¦ÃÂ¬ÃÂ¡ÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂ</th><th>ÃÂ¦ÃÂÃÂÃÂ¥ÃÂ¾ÃÂÃÂ©ÃÂ»ÃÂÃÂ¦ÃÂÃÂ</th></tr>
{cust_rows}</table></div>
</body></html>""")

# ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ Clicks API ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
@app.get("/api/clicks")
...
# Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂ Product Recommendations Ã¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂÃ¢ÂÂ
import csv as _csv
import io as _io
import re as _re
...
def _parse_tags(cats: str, tag_str: str, artist: str) -> list:
    ...
    tags = [t.strip().lower() for t in _re.split(r"[,Ã¯Â¼Â;Ã¯Â¼Â|Ã¯Â½Â/\\]+", combined) if t.strip()]
    if artist:
...
def _recommend(products: list, current_slug: str, limit: int = 4) -> dict:
    ...
    # ── Section 2: one random work per tag (diverse across tags) ───────
    used = {current_slug} | {p["slug"] for p in by_artist}
    seen_slugs = set(used)
    by_tag: list = []

    tags_shuffled = list(current["tags"])
    _random.shuffle(tags_shuffled)

    for tag in tags_shuffled:
        candidates = [p for p in products
                      if p["slug"] not in seen_slugs and tag in p["tags"]]
        if candidates:
    ...
    # Pad with random works if not enough tag matches
    if len(by_tag) < limit:
        rest = [p for p in products if p["slug"] not in seen_slugs]
